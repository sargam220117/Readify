    ...
    >
      <div className={`w-full aspect-[3/4] ${imageUrl ? '' : imageColor} rounded-md shadow-md mb-4 flex items-center justify-center overflow-hidden shadow-amber-900/10 dark:shadow-none relative`}>
        ...
        <button 
          ...
          className={`absolute top-4 right-4 p-2 rounded-full transition-all duration-300 transform ${
            isWishlisted 
        ...
        <button 
          ...
          disabled={adding}
          className={`opacity-0 group-hover:opacity-100 absolute bottom-4 left-1/2 -translate-x-1/2 ${
            adding ? 'bg-emerald-600' : 'bg-[#1a1a1a] dark:bg-amber-600'
